        ...
        NavigationStack {
            ScrollView {
                VStack(alignment: .leading, spacing: 18) {
                    HStack(spacing: 12) {
                        statCard(title: "Entries", value: "\(model.ledgerEntries.count)", tint: .green)
                        statCard(
                            title: "Latest",
                    ...
                    if model.ledgerEntries.isEmpty {
                        VStack(spacing: 12) {
                            ...
                            Text("No bookkeeping entries yet")
                                .font(.headline)
                            Text("Upload a receipt or payment screenshot from the Capture tab to create your first ledger item.")
                                .font(.subheadline)
